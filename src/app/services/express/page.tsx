                ...
                <div className="max-w-7xl mx-auto relative z-10">
                    ...
                    >
                        ...
                        <p className="text-xl text-gray-400 max-w-2xl leading-relaxed mb-12">
                            Быстрый запуск на готовых решениях и шаблонах Битрикс.
                            Идеально для малого бизнеса, проверки гипотез и старта продаж за 1-2 недели.
                        </p>
            ...
            <section className="py-24 px-6 border-b border-border bg-background">
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {[
                            { title: "Лицензия 1С-Битрикс", desc: "Редакция 'Малый Бизнес' или 'Бизнес'. Официальный ключ." },
                            ...
                            { title: "Обучение", desc: "Видео-уроки по наполнению каталога и обработке заказов." }
                        ].map((item, i) => (
            ...
            <Guarantees items={[
                {
                    ...
                    description: "Мы — золотые партнеры 1С-Битрикс. Вы получаете официальную лицензию и обновления.",
                    icon: Shield
                },
                {
                    title: "Обучение",
                    description: "Записываем персональные видео-инструкции. Вы сможете управлять сайтом сами.",
                    icon: MonitorPlay
                },
                {
                    title: "Сроки",
                    description: "Фиксируем сроки запуска в договоре. Обычно это 10-14 рабочих дней.",
                    icon: Clock
                },
                {
                    title: "Поддержка",
                    description: "Месяц технической поддержки после запуска в подарок.",
                    icon: LifeBuoy
                }
            ]} />
        </main>
