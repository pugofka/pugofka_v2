                ...
                <div className="max-w-7xl mx-auto relative z-10">
                    ...
                    >
                        ...
                        <p className="text-xl text-gray-400 max-w-2xl leading-relaxed mb-12">
                            Запускаем MVP за 1-3 месяца. Превращаем идеи в работающий продукт.
                            Работаем как автономная продуктовая команда: проектируем архитектуру и ускоряем выход на рынок.
                        </p>
                ...
                <div className="max-w-7xl mx-auto px-6">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
                        ...
                        <div>
                            ...
                            <p className="text-gray-400 leading-relaxed">
                                Мы не просто исполнители. Усилим команду вашего CTO или полностью возьмем управление разработкой на себя.
                            </p>
                        </div>
                        <div>
                            <h3 className="text-2xl font-bold uppercase mb-6 flex items-center gap-3">
